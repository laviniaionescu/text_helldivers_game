...
if __name__ == '__main__':
    ...
    # access the json with the mission data
    ...
    for mission in mission_data["mission_type"]:
        print(mission)
...
####################################################################################
    ...
    match mission_pick:
        case 1:
            rescue_civs = main_functions.rescue_operation(stats, mission_data['civilian_status'])
        ...
        case 2:
            ...
            main_functions.generator_boot(20, mission_data['generator_hp'], stats)
